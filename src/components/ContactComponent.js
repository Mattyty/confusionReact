...
class Contact extends Component {
    ...
    // regex syntax to check all characters are numbers below 'reg = /^\d+$/;'
        ...
        return (
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    {// 'row' (below) allows you to use bootstrap grid system within a form, outside of className, Col is like div classname md-10. its shorthand)
                    }
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                {// below = occupy 6 rows but offset 2
                                }
